<h3><?php _e("Acronyms", "ff-html-enhancer"); ?></h3>

<p>
<?php _e("An acronym is an abbreviation that can be pronounced just like a word (ex.: laser, captcha).", "ff-html-enhancer"); ?>
</p>

<table>
<tr>
	<th><?php _e("Acronym", "ff-html-enhancer"); ?></th>
	...
	<td>
		<select name="lang[]">
			...
			foreach ($langs as $code => $name) {
				echo '<option value="' . $code . '"' . glimpse_HtmlEnhancerPlugin::addSelectedAttribute($code, $htmlLink->lang) . '>' . __($name, "html-enhancer") . '</option>';
			}
			?>
		</select>
	</td>
